...
public class Level2 implements Level {
	...
	public void instantiateObstacles() {
		...
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/truck1"+"Right.png",0, 0, 649, 3, 120, 120, 0));
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/truck1"+"Right.png",0,300, 649, 3, 120, 120,0));
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/car1Left.png",0, 100, 597, 6, 50, 50,0));
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/car1Left.png",0, 250, 597, 6, 50, 50,0));
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/car1Left.png",0, 400, 597, 6, 50, 50,0));
		background.add((Actor) factory.getObstacle("VEHICLE","file:src/misc/car1Left.png",0, 550, 597, 6, 50, 50,0));
